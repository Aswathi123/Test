      ...
      <body>
		...
		<!-- End Google Tag Manager (noscript) -->
         ...
         <!-- PAGE CONTENT BEGINS -->
               ...
               <cfif getPlan.Company_Service_Plan_ID gt 1 AND ( DateDiff('d',Now(),getTrialExpiration.Trial_Expiration) lt 32 AND (NOT getTrialExpiration.Trial_Expiration LTE CreateDate(2018,9,30)))>
