<cfcomponent displayname="appointmentsCalendarBean" hint="appointmentsCalendarBean" output="false">
	...
	<cffunction name="bookAppointment" access="remote" output="false" returntype="string" returnformat="plain">
		...
		<!--- <cfdump var="#eventStr.endTime#"> --->
		<!--- <cfdump var="#DateFormat(dtOne,"yyyymmdd")#" label="app">
		<cfdump var="#TimeFormat(dtOne, "HHmmss")#" label="app2">
 --->
		...
		<!--- <cfset endDate = DateAdd("n",30,dtOne)> --->
		<cfset eventStr = {} >
		<cfset eventStr.organizerName = "Aswathi">
		<cfset eventStr.organizerEmail = "aswathi.k@spericorn.com">
		<cfset eventStr.startTime = arguments.StartDateTime>
		<cfset eventStr.endTime= arguments.EndDateTime>
		<cfset eventStr.subject = "Your Appointment details">
		<cfset eventStr.location = "Test">
		<cfset eventStr.description = "Test description">
		...
		<cftransaction>
			...
			<cfmail from="no-reply@salonworks.com" To="#local.qryResults.CustomerEmail#" replyto="no-reply@salonworks.com" Subject="Your Appointment with #local.qryResults.CustomerName# #DateFormat(arguments.AppointmentStartDate,"dddd")# #DateFormat(arguments.AppointmentStartDate,"long")# #TimeFormat(arguments.AppointmentStartTime,"short")#" server="smtp-relay.sendinblue.com" port="587"  username="ciredrofdarb@gmail.com" password="2xf5ZLbMdyDr0VSv">
				<cfoutput>
																			...
																			<tr style="font-family: Arial, sans-serif; line-height: 19px; color: ##444444; font-size: 13px;">
																				<td class="table-row-td" style="padding-right: 16px; font-family: Arial, sans-serif; line-height: 19px; color: ##444444; font-size: 13px; font-weight: normal; vertical-align: middle;" valign="middle" align="left">
																					<a href="##" style="color: ##ffffff; text-decoration: none; padding: 10px 0px; font-size: 18px; line-height: 20px; height: auto; background-color: transparent;">
																						Your Appointment with #local.qryResults.CustomerName# #DateFormat(arguments.AppointmentStartDate,"dddd")#  #DateFormat(arguments.AppointmentStartDate,"long")# #TimeFormat(arguments.AppointmentStartTime,"short")#
																					</a>
																				</td>
															...
															<tr>
																<td class="table-col-td" width="267" style="font-family: Arial, sans-serif; line-height: 19px; color: ##444444; font-size: 13px; font-weight: normal;" valign="top" align="left">
																	<table class="header-row" width="267" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;">
																		<tbody>
																			<tr>
																				<td class="header-row-td" width="267" style="font-size: 28px; margin: 0px; font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: ##478fca; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left"><img src="http://salonworks.com/images/staff/#arguments.Professional_ID#.jpg" alt="#local.qryResults.CustomerName#" id="personImg" width="220px"></td>
																			</tr>
																			<tr>
																				<td class="header-row-td" width="267" style="font-size: 28px; margin: 0px; font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: ##478fca; padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">#local.qryResults.CustomerName#
																				</td>
																	...
																	<p style="margin: 0px; font-family: Arial, sans-serif; line-height: 19px; color: ##444444; font-size: 13px;">
																		Thank you for booking an appointment with <cfoutput>#local.qGetCompanyDetails.Company_Name#</cfoutput>. We look forward to serving you! If you have any questions, please contact <cfoutput>#local.qryResults.ProfessionalName# at #local.qryResults.ProfessionalEmail#</cfoutput>.
																			...
																			<!--- Click <a href="http://salonworks.com/customer_profile.cfm?eflgsignup=1">here</a> to view your appointments, or update your profile. --->
																	</p>											
																	<br>
																	<!---
    ...
    <cfscript>
    	function iCalUS(stEvent) {
		    ...
		    if (NOT IsDefined("stEvent.endTime"))
		        stEvent.endTime = ParseDateTime("10/30/2019 15:30");  // Example end time is 21-March-2008 3:30 PM Eastern
	...
	<cffunction name="getCustomerAppointmentHistory" access="remote" output="false" returntype="query">
		...
		<cfquery name="local.qryResults" datasource="#request.dsn#">
			...
			SELECT      Appointments.Appointment_ID, Professionals.First_Name, Professionals.Last_Name, Locations.Location_Address, Locations.Location_Address2
						,Locations.Location_City, Locations.Location_State, Locations.Location_Postal, Locations.Location_Phone
						,Predefined_Services.Service_Name, Appointments.Start_Time, Appointments.End_Time
						,Time_Zones.Offset, Timezone_Location
			FROM            
						Appointments 
						INNER JOIN
							Predefined_Services ON Appointments.Service_ID = Predefined_Services.Service_ID 
						INNER JOIN
							Professionals ON Appointments.Professional_ID = Professionals.Professional_ID 
						INNER JOIN
							Locations ON Professionals.Location_ID = Locations.Location_ID 
	...
	<cffunction name="getBookAppointment" access="remote" output="false" returntype="query">
		...
		<cfquery name="local.qryResults" datasource="#request.dsn#">
			...
			SELECT        Professionals.First_Name, Professionals.Last_Name, Locations.Location_Name, Locations.Location_Address, Locations.Location_Address2, Locations.Location_City, 
			                         Locations.Location_State, Locations.Location_Postal, Locations.Location_Phone, Predefined_Services.Service_Name, Appointments.Start_Time, Appointments.End_Time, 
			                         Time_Zones.Offset, Timezone_Location, Professionals.Email_Address
			FROM            Appointments INNER JOIN
	...
	<cffunction name="getProfessionalsListByService" access="remote" output="false" returnFormat="json" returntype="struct">
		...
		<cfquery name="local.qryResults" datasource="#request.dsn#">
            SELECT DISTINCT  Professionals.Professional_ID
            				,Professionals.Title_ID
            				,Professionals.Last_Name
            				,Professionals.First_Name
            FROM Professionals INNER JOIN Professionals_Services 
            ON Professionals.Professional_ID = Professionals_Services.Professional_ID
            WHERE Professionals.Active_Flag = 1 
            AND
	...
	<cffunction name="getProfessionalServices" access="public" output="false" returntype="query">
		...
		<cfquery name="qGetServicesByProfessionals" datasource="#request.dsn#">
			SELECT DISTINCT <!--- Service_Types.Service_Type_Name, ---> Predefined_Services.Service_ID, Predefined_Services.Service_Name, Professionals_Services.Price, Professionals_Services.Service_Time<!--- , Service_Types.Service_Type_Display_Order --->
			FROM            Predefined_Services <!--- INNER JOIN
			                         Service_Types ON Services.Service_Type_ID = Service_Types.Service_Type_ID ---> INNER JOIN
			                         Professionals_Services ON Predefined_Services.Service_ID = Professionals_Services.Service_ID INNER JOIN
	...
	<cffunction name="getServicesListByProfessional" access="remote" output="false" returnFormat="json" returntype="struct">
		...
		<cfset local.Response = {
        					...
        					DATA = []} />             
		<cfquery name="local.qryResults" datasource="#request.dsn#">
			SELECT DISTINCT  	Predefined_Services.Service_ID,
			 					Predefined_Services.Service_Name,
			 					Professionals_Services.Price,
			 					Professionals_Services.Service_Time
			FROM           		Predefined_Services INNER JOIN Professionals_Services 
								ON Predefined_Services.Service_ID = Professionals_Services.Service_ID INNER JOIN Professionals 
								ON Professionals_Services.Professional_ID = Professionals.Professional_ID
			WHERE 				Professionals.Location_ID = <cfqueryparam value="#arguments.Location_ID#" cfsqltype="cf_sql_integer" />
			<cfif arguments.Professional_ID GT 0>
				AND Professionals.Professional_ID = <cfqueryparam value="#arguments.Professional_ID#" cfsqltype="cf_sql_integer" />
			</cfif>			
        </cfquery> 
		<cfset local.rowIndex = 1 />
		<cfloop query="local.qryResults">
...
<cffunction name="updateAvailabilityTypeMonthlyWeek" access="remote" output="false" returnFormat="json" returntype="struct">
  ...
  <cffunction name="updateAvailabilityTypeYearlyMonth" access="remote" output="false" returnFormat="json" returntype="struct">
  	...
  	<cffunction name="addAvailabilityTypeMonthlyWeek" access="remote" output="false" returntype="struct">
        ...
        <cfargument name="RecurrenceOrdinalIntervalID" type="numeric" required="true" />
        <cfargument name="RecurrenceWeekdayIntervalID" type="numeric" required="true" />
        <cfargument name="RecurCountInterval" type="numeric" required="true" default="1"/>
        <cfargument name="EndRecurrenceDate" type="string" required="false" />
        <cfargument name="EndAfterOcurrences" type="numeric" required="false" />
        <cfargument name="recurrenceRangeType" type="numeric" required="false" />          
       <!---  <cfdump var="#arguments#"><cfabort> --->
	...
	<cffunction name="getProfessionalAppointments" access="remote" output="false" returntype="query">
		...
		<cfquery name="local.qryResults" datasource="#request.dsn#">
            ...
            SELECT        Appointments.Appointment_ID AS 'id', Appointments.Start_Time AS Start_Date, Appointments.End_Time AS End_Date, 
						'|' + REPLACE(Predefined_Services.Service_Name , '''', '') + ' - ' +  Customers.First_Name + ' ' + Customers.Last_Name  AS 'title'
			FROM            Appointments INNER JOIN
			                         Customers ON Appointments.Customer_ID = Customers.Customer_ID INNER JOIN
			                         Predefined_Services ON Appointments.Service_ID = Predefined_Services.Service_ID
            WHERE 	Appointments.Professional_ID = <cfqueryparam value="#arguments.Professional_ID#" cfsqltype="cf_sql_integer" /> AND 
...
<!--- 			<cfset rs.temp['service_name'] = rs.q['Service_Name'][rs.q.currentrow] />
	...
	<cffunction name="getRecurrenceTypeDailyDays" access="public" output="false" returntype="Query">
		...
		<cfquery name="local.qryRecurResults" datasource="#request.dsn#">
      	...
      	<cfif local.qryRecurResults.recordcount >
	        ...
	        <cfloop query="local.qryRecurResults">
	            ...
	            <cfif local.qryRecurResults.Recur_Count_Interval eq 0 >
	            	<cfset local.Recur_Count_Interval_ = 1 >
	            <cfelse>
	            	<cfset local.Recur_Count_Interval_ = local.qryRecurResults.Recur_Count_Interval >
	            </cfif>
	            <cfdump var="#local.qryRecurResults.Recur_Count_Interval#" label="inetr">
	            ...
	            <cfif local.qryRecurResults.Recurrence_Range_Type_ID EQ this.RECURRENCE_RANGE_TYPE_NO_END_DATE>
	                <cfloop from="#local.position#" to="#arguments.CalendarDaysSpan-1#" index="local.k">
	                    <cfif (local.LoopModCount MOD local.Recur_Count_Interval_) EQ 0>
	            ...
	            <cfelseif local.qryRecurResults.Recurrence_Range_Type_ID EQ this.RECURRENCE_RANGE_TYPE_END_BY_DATE>         
	                ...
	                <cfset local.RecurCountInterval = local.Recur_Count_Interval_ />
	                <cfloop from="#local.position#" to="#arguments.CalendarDaysSpan-1#" index="local.k">
