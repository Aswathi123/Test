		 ...
		 <section class="contact-section operations-section">
			<div class="container outer-container-layout welcome-container">
				<div class="row">
					<div class="col-lg-8 col-md-12 col-12 contact-section">
						...
						<cfif IsDefined("session.CustomerID")>
							...
							<form id="frmProfile" name="frmProfile" action="customer_profile.cfm" method="post">
								...
								<div class="row">
									<label for="Email" class="col-md-4 font-size">Your Email Address :</label>
									<div class="col-md-8">
										<input type="text" id="EmailAddress" name="EmailAddress" class="form-text" maxlength="100" value="#qryCustomer.Email_Address#" />
									</div>
								</div><br>			
								<div class="row">
									<label for="FirstName" class="col-md-4 font-size">Your First Name :</label>
									<div class="col-md-8">
										<input type="text" id="FirstName" name="FirstName" class="form-text" maxlength="50" value="#qryCustomer.First_Name#" />
									</div>
								</div><br>
								<div class="row">
									<label for="LastName" class="col-md-4 font-size">Your Last Name :</label>
									<div class="col-md-8">
										<input type="text" id="LastName" name="LastName" class="form-text" maxlength="50" value="#qryCustomer.Last_Name#" />
									</div>
								</div><br>
								<div class="row">
									<label for="Password" class="col-md-4 font-size"></label>
									<div class="col-md-8">
										<a href="##" class="changeCustomerPassword" id="customer_#session.CustomerID#">Change password</a>
									</div>
								</div><br/>
								<div class="row">
									<label for="Phone" class="col-md-4 font-size">Your Phone :</label>
									<div class="col-md-8">
										<input type="text" id="MobilePhone" name="MobilePhone" class="form-text" maxlength="12" value="#qryCustomer.Mobile_Phone#" /><br />
										Example: 512-753-0000
									</div>
								</div><br>
								<div class="row">
									<label for="Phone" class="col-md-4 font-size">Your Home Phone :</label>
									<div class="col-md-8">
										<input type="text" id="HomePhone" name="HomePhone" class="form-text" maxlength="12" value="#qryCustomer.Home_Phone#" /><br />
									</div>
								</div><br>
								<div class="row">
									<label for="Address" class="col-md-4 font-size">Your Address :</label>
									<div class="col-md-8">
										<input type="text" id="Address" name="Address" class="form-text" maxlength="50" value="#qryCustomer.Address#" />
									</div>
								</div><br>
								<div class="row">
									<label for="Address" class="col-md-4 font-size">Your Address2 :</label>
									<div class="col-md-8">
										<input type="text" id="Address2" name="Address2" class="form-text" maxlength="50" value="#qryCustomer.Address2#" />
									</div>
								</div><br>
								<div class="row">
									<label for="City" class="col-md-4 font-size">Your City :</label>
									<div class="col-md-8">
										<input type="text" id="City" name="City" class="form-text" maxlength="50" value="#qryCustomer.City#" />
									</div>
								</div><br>
								<div class="row">
									<label for="State" class="col-md-4 font-size">Your State :</label>
									<div class="col-md-8 form-cntrl">
								...
								<div class="row">
									<label for="Postal" class="col-md-4 font-size">Your Postal :</label>
									<div class="col-md-8">
										<input type="text" id="Postal" name="Postal" class="form-text" maxlength="5" value="#qryCustomer.Postal#" />
									</div>
								</div><br>			
								<div class="row">
									<label for="day" class="col-md-4 control-label font-size">Birth Date :</label>
									<div class="col-md-8 form-group form-cntrl-date">
								...
								<div class="row">
									<label for="customerNotes" class="col-md-4 control-label font-size">Customer Notes</label>
								...
								<div class="row">
									<div class="col-md-8">
										<button type="button" id="btnUpdateProfile" class="btn buttonStyle" >Update Profile</button>
									</div>
								</div>
					...
					<div class="col-lg-4 col-md-12 col-12 timing-table-content table-content" name="timing-table-content">
						</br></br></br>
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<!--- <cfset customer_id=#session.CustomerID#> --->
