<?xml version="1.0" encoding="UTF-8"?><!-- copy from Railo context --><cfLuceeConfiguration hspw="682180789716d847e6dcfab3ec550fb8519452cdf4f68b8e47d4009b912e3f32" salt="641480F5-6BDD-4701-BA205CBDF7B3641C" version="5.2"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="com.microsoft.jdbc.sqlserver.SQLServerDriver" clob="false" connectionTimeout="1" custom="DATABASENAME=SalonWorks&amp;sendStringParametersAsUnicode=true&amp;SelectMethod=direct" database="SalonWorks" dbdriver="MSSQL" dsn="jdbc:sqlserver://{host}:{port}" host="localhost" metaCacheTimeout="60000" name="salonworks" password="encrypted:8322ed8eda35ac1ca594a954d59e9a5a65a3a4c7c4456e1d449a510aa5b6ee39" port="1433" storage="false" username="sa" validate="false"/></data-sources>
