<style>
 ...
 <cftry> 
<!--- <cfdump var="#Form["g-Recaptcha-Response"]#">
 <cfhttp url="https://www.google.com/recaptcha/api/siteverify" method="post" result="captchaResponse">
	<cfhttpparam  name="secret"  type="FORMFIELD"  value="6LcHC30UAAAAAA--AM2kmJUWV2YmOdwfU3FivPzo">
...
<cfmail from="salonworks@salonworks.com" to="jacinth@spericorn.com" bcc="jacinth@spericorn.com" subject="Welcome To SalonWorks" server="smtp-relay.sendinblue.com" port="587" username="ciredrofdarb@gmail.com" password="2xf5ZLbMdyDr0VSv" type="HTML">
								...
								<table style="width: 840px; margin: auto; border-spacing: 0px;"><!--text-content-->
									<tbody>
										<tr class="" style="width: 100%; background: ##fff; text-align: center;">
											<td style="padding: 20px 0;"> <a href=""><img src="http://13.58.245.95:8500/img/logo.png" alt=""></a></td>
										</tr>
										...
										<table border="0" cellspacing="0" cellpadding="0" style=" height:95px; width: 100%; text-align: center; background: ##2995d3; padding: 34px 5px;">
											<tr>
												<td style="width: 33%; float: left; ">
													<a href="https://www.facebook.com/pages/Salonworks/1434509316766493" style="margin-right: 10px;"><img src="http://13.58.245.95:8500/images/facebook_round.png" alt=""></a>
												</td>
												<td style="width: 33%; float: left; font:14px/23px 'Roboto', sans-serif, arial;">
													<img src="http://13.58.245.95:8500/images/call.png" alt="" style="vertical-align: middle; margin-right: 5px;">
													<label>
													 <a href="tel:+ (978) 352-0235" style="color: ##fff; text-decoration:  none;">+ (978) 352-0235</a>
													</label>
												</td>
												<td style="width: 33%; float: left; font:14px/23px 'Roboto', sans-serif, arial;">
													<img src="http://13.58.245.95:8500/images/mail.png" alt="" style="vertical-align: middle; margin-right: 5px;">
													<label>
