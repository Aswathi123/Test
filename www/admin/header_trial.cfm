		...
		<!-- End Google Tag Manager (noscript) -->
         ...
         <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
               ...
               <li>
                  <cfif not( getPlan.Company_Service_Plan_ID gt 1  AND (DateDiff('d',Now(),getTrialExpiration.Trial_Expiration) lt 14 AND (NOT getTrialExpiration.Trial_Expiration LTE CreateDate(2018,9,30)))) >
         ...
         <!-- PAGE CONTENT BEGINS -->
               ...
               <cfif getPlan.Company_Service_Plan_ID gt 1 AND ( DateDiff('d',Now(),getTrialExpiration.Trial_Expiration) lt 14 AND (NOT getTrialExpiration.Trial_Expiration LTE CreateDate(2018,9,30)))>
