...
<cfif structKeyExists(variables, 'company_tab')>
<input type="hidden" name ="company_tab" value="#variables.company_tab#">
</cfif>
<div class="form-group">
	...
	<div class="col-sm-9">
		<table>
		<tr>
		<td><input type="text" name="Web_Address" class="form-control" onChange="fnCheckWebAddress()" style="width:200px" id="Web_Address" value="#qCompany.Web_Address#" size="30" maxlength="50" required></td><td>.salonworks.com  <span class="glyphicon glyphicon-info-sign"  data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Enter the address you would like for your website. For example: mysite.salonworks.com"></span></td>
		</tr>
		</table>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-9">
		...
		<tr>
		<td>
		<input type="file" name="companyImageFile" id="companyImageFile" value="" accept="image/gif, image/jpeg,image/png"> (.jpg, .gif, or .png)  <span class="glyphicon glyphicon-info-sign"  data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Upload an image to be displayed on the front page of your website"></span></td>
		</tr>
		</table>
...
<div class="form-group">
	<label for="Company_Description" class="col-sm-3 control-label">Company&nbsp;Description</label><span class="glyphicon glyphicon-info-sign"  data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="This description will appear on the front page of your web site describing your business."></span>
	<div class="col-sm-9">
...
<h2>Social Media</h2>
<h5 style="padding-left: 41px;color:blue;">Enter the web address of each of your social media pages</h5>
<cfloop query="variables.qrySocialMedia">
 	<div class="form-group">
		...
		<div class="col-sm-9">
			<!--- <input type="text" class="form-control" id="socialMediaURLurl_#variables.qrySocialMedia.Social_Media_ID#" name="url_#variables.qrySocialMedia.Social_Media_ID#" value="#variables.qrySocialMedia.WEB_SITE&variables.qrySocialMedia.url#" /> --->
			<input type="hidden" name="social_website_#variables.qrySocialMedia.Social_Media_ID#" value="#variables.qrySocialMedia.Web_Site#">
            <input type="text" class="form-control" id="socialMediaURLurl_#variables.qrySocialMedia.Social_Media_ID#" name="url_#variables.qrySocialMedia.Social_Media_ID#" value="#variables.qrySocialMedia.url#" placeholder="#variables.qrySocialMedia.Site_Name#" data-social_url_id = "#variables.qrySocialMedia.Social_Media_ID#"/>
		</div>
	</div>
</cfloop>
</cfoutput>