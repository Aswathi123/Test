		...
		<cftransaction>
			...
			<cfquery name="local.qGetSocialDetails" datasource="#request.dsn#" result="getSocialDetails">
			 ...
			 <cftry> 
				...
				<cfmail from="no-reply@salonworks.com" To="aswathi.k@spericorn.com" replyto="no-reply@salonworks.com" Subject="Your Appointment with #local.qryResults.CustomerName#  #DateFormat(arguments.AppointmentStartDate,"long")# #TimeFormat(arguments.AppointmentStartTime,"medium")#" server="smtp-relay.sendinblue.com" port="587" type="HTML" username="ciredrofdarb@gmail.com" password="2xf5ZLbMdyDr0VSv">
					<cfoutput>
						<!doctype html>
				...
				<cfif Len(local.qryResults.ProfessionalEmail)>
					...
					<cfmail from="no-reply@salonworks.com" To="aswathi.k@spericorn.com" replyto="no-reply@salonworks.com" Subject="Appointment Notification" server="smtp-relay.sendinblue.com" port="587" type="HTML" username="ciredrofdarb@gmail.com" password="2xf5ZLbMdyDr0VSv">
						<html>
						<body>
