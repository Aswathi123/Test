														...
														<tbody>
															<tr>
																<td class="table-col-td" width="267" style="font-family: Arial, sans-serif; line-height: 19px; color: ##444444; font-size: 13px; font-weight: normal;" valign="top" align="left">
																	...
																	Thank you for booking your appointment with <cfoutput>#local.qGetCompanyDetails.Company_Name#</cfoutput>, We look forward to serving you! If you have any questions, please contact #local.qryResults.ProfessionalName# at #local.qryResults.ProfessionalEmail#.
																		...
																		<tbody>
																			<tr>
																				<td width="100%" bgcolor="##f5f5f5" style="font-family: Arial, sans-serif; line-height: 19px; color: ##444444; font-size: 13px; font-weight: normal; padding: 19px; border: 1px solid ##e3e3e3; background-color: ##f5f5f5;" valign="top" align="left">
																					...
																					<span style="font-family: Arial, sans-serif; line-height: 19px; color: ##31708f; font-size: 13px;">#local.qryResults.LocationDesc#</span>
																				</td>
																			</tr>
																		</tbody>
																	</table>
