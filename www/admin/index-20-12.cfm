										...
										<div class="col-md-4 col-xs-12 mbm-10">
											<select name="BreakBegin_#dayindex#" id="BreakBegin_#dayindex#" class="form-control">
												...
												<cfloop from="1" to="24" index="i">
													...
													<option value="#h#:00 #meridiem#">#h#:00 #meridiem#</option>
													<option value="#h#:15 #meridiem#">#h#:15 #meridiem#</option>
													<option value="#h#:30 #meridiem#">#h#:30 #meridiem#</option>
													<option value="#h#:45 #meridiem#">#h#:45 #meridiem#</option>
												</cfloop>
											</select>
										</div>
										<div class="col-md-4 col-xs-12 text-center mbm-10 texts">
