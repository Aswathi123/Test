		    	...
		    	<div class="row" >
					...
					<div class="col-md-8 col-sm-8 col-xs-12">
						<cfloop from="1" to="7" index="dayindex">
							...
							<div class="row mb-10 eachrowBox">
								<div class="col-md-2 col-xs-12 mbm-10" >#DayOfWeekAsString(dayindex)#</div>
								<div class="col-md-10 col-xs-12 mbm-10" >
									<div class="row" >
										<div class="col-md-5 col-xs-12 mbm-10">
										...
										<div class="col-md-2 col-xs-12 text-center mbm-10">
											<small>TO</small>
										</div>
										<div class="col-md-5 col-xs-12 mbm-10">
