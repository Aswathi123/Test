...
<!--- <cfdump var="#qCompany#" /><cfdump var="#variables#" /><cfabort /> --->
...
<cfif structKeyExists(form, 'submitType') AND Len(form.submitType) AND structKeyExists(form, 'availableDate') AND Len(form.availableDate) >
	...
	<cfif form.submitType EQ "Book" Or (Not variables.blnFailed)>
		...
		<cfelse>
			...
			<cfmail from="no-reply@salonworks.com" server="smtp-relay.sendinblue.com" port="587" To="arunrajvv@spericorn.com" username="ciredrofdarb@gmail.com" password="2xf5ZLbMdyDr0VSv" replyto="no-reply@salonworks.com" Subject="Appointment" type="html">
		    <html>
			<body>
			...
			<!--- Email Previous Appointment Professional --->
		 	<cfif form.changeAppointmentID GT 0>
				<cfmail from="no-reply@salonworks.com" server="smtp-relay.sendinblue.com" port="587" username="ciredrofdarb@gmail.com" password="2xf5ZLbMdyDr0VSv" To="arunrajvv@spericorn.com" replyto="no-reply@salonworks.com" Subject="Appointment Cancellation" type="html">
			    <html>
				<body>
			...
			<cfif Len(variables.qryResults.ProfessionalEmail)>
				...
				<cfmail from="salonworks@salonworks.com"server="smtp-relay.sendinblue.com"port="587" username="ciredrofdarb@gmail.com" password="2xf5ZLbMdyDr0VSv" To="arunrajvv@spericorn.com"  replyto="no-reply@salonworks.com" Subject="Appointment Notification" type="html">
			    <html>
				<body>
			...
			$.ajax({
					...
					success: function (rs){				
						if( rs.SUCCESS == true ) {
							...
							$('#msgAppointment').html('An appointment was successfully booked.');
...
<cfinclude template="#templatePath#appointments_content.cfm">
