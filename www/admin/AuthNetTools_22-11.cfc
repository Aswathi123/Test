...
<cfset variables.login = "7BPc46jba3"><!--- may be passed in as an argument to the init method, or entered manually here, or passed in as an argument with each individual method to overwrite what is entered here. --->
<cfset variables.transactionkey = "8V7N467pmu8XSskR"><!--- may be passed in as an argument to the init method, or entered manually here, or passed in as an argument with each individual method to overwrite what is entered here. --->
...
<cfset variables.url_gateway = "https://secure.authorize.net/gateway/transact.dll">
...
<createCustomerProfileRequest xmlns="AnetApi/xml/v1/schema/AnetApiSchema.xsd">
  <merchantAuthentication>
    <name>7BPc46jba3</name>
    <transactionKey>8V7N467pmu8XSskR</transactionKey>
  </merchantAuthentication>
...
<cfargument name="cardcode" type="string" default="">
<cfargument name="description" type="string" default="">
<cfargument name="recurring_billing" type="boolean" default="false">
<cfargument name="taxExempt" type="boolean" default="false">
<cfargument name="ipaddress" type="string" default="#cgi.remote_addr#">
<cfargument name="useXmlFormat" type="boolean" default="#variables.defaultXmlFormat#">
<cfargument name="allowPartialAuth" type="any" default=""><!--- input boolean true or false to overwrite merchant settings  --->
...
<ARBCreateSubscriptionRequest xmlns="AnetApi/xml/v1/schema/AnetApiSchema.xsd">
  ...
  <subscription>
    ...
    <amount>#rereplace(decimalFormat(rereplace(arguments.amount, "[^0-9\.-]+", "", "ALL")), "[^0-9\.-]+", "", "ALL")#</amount><CFIF isNumeric(arguments.trialOccurrences) and arguments.trialOccurrences GT 0>
    ...
    <customer>
      <id>#arguments.merchantCustomerId#</id>
      <email>#arguments.email#</email>
      <phoneNumber>#rereplace(arguments.phoneNumber, "[^0-9-()]+", "", "ALL")#</phoneNumber><!--- Up to 25 digits (no letters) Ex. (123)123-1234 --->
      <faxNumber>#rereplace(arguments.faxNumber, "[^0-9-()]+", "", "ALL")#</faxNumber><!--- Up to 25 digits (no letters) Ex. (123)123-1234 --->
    </customer>
